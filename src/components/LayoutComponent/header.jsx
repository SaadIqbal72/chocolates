            ...
            <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
                ...
                <el-popover-group className="hidden lg:flex lg:gap-x-12">
                    ...
                    <div className="relative">
                        ...
                        <el-popover id="desktop-menu-product" anchor="bottom" popover className="m-0 w-screen max-w-md overflow-hidden rounded-3xl bg-gray-800 p-0 outline outline-1 -outline-offset-1 outline-white/10 transition [--anchor-gap:theme(spacing.3)] [transition-behavior:allow-discrete] backdrop:bg-transparent open:block data-[closed]:translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in">
                            <div className="p-4">
                    ...
                    <a href="#" className="text-sm/6 font-semibold text-white">Flavours</a>
                    {/* <a href="#" className="text-sm/6 font-semibold text-white">Contact us</a>
                    <a href="#" className="text-sm/6 font-semibold text-white">Company</a> */}
                </el-popover-group>
                <div className="hidden flex gap-[15px] lg:flex lg:flex-1 lg:justify-end">
                    <a href="#" className="text-sm/6 font-semibold text-white">
                    <FontAwesomeIcon icon={faCartShopping} />
                        <span classNameName="text-[10px] w-[20px] h-[20px] flex items-center justify-center rounded-full bg-[#f00]">2</span>
                    </a>
                    <a href="#" className="text-sm/6 font-semibold text-white">Log in <FontAwesomeIcon icon={faCoffee} /></a>
                    {/* <a href="#" className="text-sm/6 font-semibold text-white">Profile</a> */}
                </div>
            </nav>
            <el-dialog>
                            ...
                            <div className="mt-6 flow-root">
                                <div className="-my-6 divide-y divide-white/10">
                                    <div className="space-y-2 py-6">
                                        <div className="-mx-3">
                                            <button type="button" command="--toggle" commandfor="products" className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base/7 font-semibold text-white hover:bg-white/5">
                                                Product
                                                <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" className="size-5 flex-none [[aria-expanded='true']_&]:rotate-180">
                                                    <path d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" fill-rule="evenodd" />
                                                </svg>
                                            </button>
                                            <el-disclosure id="products" hidden className="mt-2 space-y-2 [&:not([hidden])]:block">
                                                <a href="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-white hover:bg-white/5">Analytics</a>
                                                <a href="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-white hover:bg-white/5">Engagement</a>
                                                <a href="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-white hover:bg-white/5">Security</a>
                                                <a href="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-white hover:bg-white/5">Integrations</a>
                                                <a href="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-white hover:bg-white/5">Automations</a>
                                                <a href="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-white hover:bg-white/5">Watch demo</a>
                                                <a href="#" className="block rounded-lg py-2 pl-6 pr-3 text-sm/7 font-semibold text-white hover:bg-white/5">Contact sales</a>
                                            </el-disclosure>
                                        </div>
